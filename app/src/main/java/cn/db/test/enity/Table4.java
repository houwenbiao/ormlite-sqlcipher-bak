 ...
 * 制热修正系数
 */
@DatabaseTable(tableName = "table4")
public class Table4
{
    ...
    public Table4(String airconType, int heatDefaultSupplyWater, double twentyFour, double fifteen, double seven, double zero, double negativeSeven, double negativeNine, double negativeFifteen, double negativeTwenty, double negativeTwentyFive, double negativeThirty)
    {
