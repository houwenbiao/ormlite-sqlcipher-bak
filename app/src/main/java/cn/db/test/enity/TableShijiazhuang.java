 ...
 * 石家庄干球温度
 */
@DatabaseTable(tableName = "tableShijiazhuang")
public class TableShijiazhuang
{
    ...
    public TableShijiazhuang()
    {
    }

    public TableShijiazhuang(String date, double hour, double drybulbTem)
    {
        this.date = date;
        this.hour = hour;
